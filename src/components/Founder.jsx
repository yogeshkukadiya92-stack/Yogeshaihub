...
const socialLinks = [
  { icon: ExternalLink, href: 'https://linkedin.com/in/yogeshkukadiya', label: 'LinkedIn', color: 'hover:text-blue-400 hover:border-blue-400/30' },
  { icon: AtSign, href: 'https://twitter.com/', label: 'Twitter', color: 'hover:text-sky-400 hover:border-sky-400/30' },
  { icon: MessageCircle, href: whatsappHref, label: 'WhatsApp', color: 'hover:text-emerald-400 hover:border-emerald-400/30' },
  { icon: Mail, href: 'mailto:yogeshkukadiya92@gmail.com', label: 'Email', color: 'hover:text-rose-400 hover:border-rose-400/30' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              <img
                src={founderPhoto}
                alt="Yogesh Patel - Founder of Yogesh AI Hub"
                className="relative w-full rounded-3xl border border-white/10 shadow-2xl shadow-indigo-500/20"
              />
              {/* Floating badge */}
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 bg-[#0d1524] border border-indigo-500/30 rounded-2xl px-5 py-3 shadow-xl shadow-black/40"
              >
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  ...
                  <span className="text-slate-500 text-xs">Surat, Gujarat, India</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div>
              <h2 className="text-4xl sm:text-5xl font-black text-white mb-2">
                Yogesh <span className="gradient-text">Patel</span>
              </h2>
              <p className="text-indigo-400 font-semibold text-lg">Founder & Chief AI Strategist</p>
            </div>

            <p className="text-slate-300 text-lg leading-relaxed">
              Helping businesses adopt AI in a practical way and building AI products that create measurable impact. I believe the best AI implementation is the one that actually gets used — and generates real ROI for your business.
            </p>

            <p className="text-slate-400 leading-relaxed">
              With 5+ years of hands-on AI implementation experience across manufacturing, e-commerce, healthcare and service industries, I've seen what works and what doesn't. My approach combines deep technical expertise with a business-first mindset — every AI system I build is designed to generate measurable returns from day one.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {socialLinks.map(({ icon: Icon, href, label, color }) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border border-white/[0.08] text-slate-400 text-sm transition-all duration-200 ${color}`}
                >
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-semibold shadow-lg shadow-indigo-500/25 hover:from-indigo-500 hover:to-violet-500 transition-all duration-300 text-sm"
            >
              Book a 1-on-1 with Yogesh →
            </a>
          </motion.div>
        </div>
      </div>
